        ...
        void SummonHelpers(uint32 entry)
        {
            switch(entry)
            {
                case NPC_LIVING_TRAINEE:
                    ...
                    if (Is25ManRaid())
                    {
                        Creature* cr = me->SummonCreature(NPC_LIVING_TRAINEE, PosSummonLiving[2].GetPositionX(), PosSummonLiving[2].GetPositionY(), PosSummonLiving[2].GetPositionZ(), PosSummonLiving[2].GetOrientation());
                        cr->SetMaxHealth(cr->GetMaxHealth()*RAID_MODE(1,5));
                ...
                case NPC_LIVING_KNIGHT:
                    ...
                    if (Is25ManRaid())
                    {
                        Creature* cr = me->SummonCreature(NPC_LIVING_KNIGHT, PosSummonLiving[5].GetPositionX(), PosSummonLiving[5].GetPositionY(), PosSummonLiving[5].GetPositionZ(), PosSummonLiving[5].GetOrientation());
                        cr->SetMaxHealth(cr->GetMaxHealth()*RAID_MODE(1,5));
                        cr->SetHealth(cr->GetMaxHealth());
                    }
                    break;
